...
//    [_videoCallButton.innerButton addTarget:self action:@selector(videoCallButtonPressed:) forControlEvents:UIControlEventTouchUpInside];
    ...
    NSLog(@"Is lobbyState.......:%u", _room.lobbyState);
    ...
    if(_room.lobbyState){
        NSLog(@"Play national anthem........");
        // Music URL
//        NSString *musicURL = @"https://upload.wikimedia.org/wikipedia/commons/2/29/National_anthem_of_Kenya%2C_performed_by_the_United_States_Navy_Band.wav";
