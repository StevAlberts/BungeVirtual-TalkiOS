...
- (NSURLSessionDataTask *)addComment:(NSNumber *)pollId withMessage:(NSString *)msg forUser:(TalkAccount *)account withCompletionBlock:(RequestCompletionBlock)block;
- (NSURLSessionDataTask *)deleteComment:(NSNumber *)commentId forUser:(TalkAccount *)account withCompletionBlock:(RequestCompletionBlock)block;
